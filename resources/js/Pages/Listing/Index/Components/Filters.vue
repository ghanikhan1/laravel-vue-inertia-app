        ...
        <div class="mb-8 mt-4 flex flex-wrap gap-2">
            <div class="flex flex-nowrap items-center">
                <input
                    ...
                    class="input-filet-l w-28"/>
                <input
                    v-model.number="filterForm.priceTo"
                    type="text" placeholder="Price To" class="input-filet-r w-28"/>
            </div>
            ...
            <div class="flex flex-nowrap items-center">
                <input
                    ...
                    type="text" placeholder="Area From" class="input-filet-l w-28"/>
                <input
                    v-model.number="filterForm.areaTo"
                    type="text" placeholder="Area To" class="input-filet-r w-28"/>
            </div>

            <button
                type="submit" class="main-normal">Filter
            </button>
